...
def main():
    ...
    if add_selectbox == 'Online':
        ...
        paperlessbilling = st.selectbox('Paperless Billing', ('Yes',
                'No'))
        ...
        mutliplelines = \
            st.selectbox('Does the customer have multiple lines', ('Yes'
                         , 'No'))
        ...
        onlinebackup = \
            st.selectbox('Does the customer have online backup', ('Yes'
                         , 'No'))
        ...
        streamingtv = st.selectbox('Does the customer stream TV', ('Yes'
                                   , 'No'))
        ...
        nofref = \
            st.number_input('Number of Referrals made by the customer',
                            min_value=0, max_value=100, value=0)

        offer = st.selectbox('Offer type subscribed by the customer ',
                             ('Offer_Offer A', 'Offer_Offer B',
                             'Offer_Offer C', 'Offer_Offer D',
                             'Offer_Offer E'))

        intype = st.selectbox('Internet type subscribed by the customer'
                              , ('Internet Type_Cable',
                              'Internet Type_DSL',
        ...
        paymentmethod = st.selectbox('Payment Method', ('Bank Withdrawl'
        ...
        container.subheader('Dataset upload')
        ...
        model_k3 = joblib.load(open(uploaded_model_k3))
